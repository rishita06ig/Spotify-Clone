...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li> <img src="image/music.svg">
                            <div class="info">
...
async function displayAlbums() {
    ...
    cardContainer.innerHTML = cardContainer.innerHTML + `<div data-folder="${folder}" class="card">
                            <div>
                                <div class="play-in-card">
                                    <svg width="50" height="40" viewBox="0 0 24 24" fill="black" xmlns="http://www.w3.org/2000/svg">
